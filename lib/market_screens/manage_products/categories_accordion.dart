...
import 'package:frontend/market_screens/manage_products/products_accordion.dart';
...
class _CategoriesAccordion extends State<CategoriesAccordion>
  ...
  void updatedExpansionIndexes(int _categoriesExpandedIndex, int _productsExpandedIndex){
    widget.updatedExpansionIndexes(_categoriesExpandedIndex, _productsExpandedIndex);
    setState(() {
      _loading = true;
    });
    getCategories().then((value) {
